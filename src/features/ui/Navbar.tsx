...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      <nav className={`fixed top-4 left-0 right-0 z-[1000] transition-all duration-500 cubic-bezier(0.16, 1, 0.3, 1) px-4 md:px-8 hidden md:block translate-y-0 opacity-100`}>
