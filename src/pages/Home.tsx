...
const Home: React.FC = () => {
  ...
  return (
    <div className="space-y-0 pb-32 overflow-x-hidden text-right bg-transparent" dir="rtl">
      ...
      <section ref={addToRevealRefs} className="reveal-on-scroll relative z-20 pt-16 md:pt-40 pb-10 overflow-hidden">
      ...
      {/* Discovery Section */}
      <section ref={addToRevealRefs} className="reveal-on-scroll max-w-7xl mx-auto px-6 pt-24 md:pt-32">
      ...
      <section ref={addToRevealRefs} className="reveal-on-scroll relative overflow-hidden pt-24 md:pt-32">
        ...
        <div className="max-w-7xl mx-auto overflow-hidden px-6 relative min-h-[400px]">
          ...
          >
            ...
            {/* Empty State */}
            {mapHotels.filter(h => activeCityTab === 'all' || (activeCityTab === 'makkah' && (h.city === 'makkah' || h.city === 'مكة المكرمة')) || (activeCityTab === 'madinah' && (h.city === 'madinah' || h.city === 'المدينة المنورة'))).length === 0 && (
